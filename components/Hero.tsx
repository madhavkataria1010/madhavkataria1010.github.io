  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center z-10">
            ...
            {/* Subtext */}
            <p className="text-2xl md:text-3xl text-gray-400 font-medium tracking-tight max-w-2xl mx-auto mb-12 animate-slide-up opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
