...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A real-time voice assistant focused on high-quality audio and user experience. Integrating VLLM inference with OrcaStation and MCP server for contextual intelligence.',
  ...
  },
  {
    ...
    description: 'High-performance agentic browser leveraging Playwright and CrewAI MCP. Orchestrates multiple agents for automated, intelligent web navigation and retrieval.',
  ...
  },
  {
    ...
    description: 'Real-time RAG pipeline using Pathway for continuous data stream synthesis. Designed for critical decision-making systems requiring low latency.',
